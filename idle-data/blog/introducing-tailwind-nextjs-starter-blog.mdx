...
- [Demo Blog](https://rajatrajdeep.in/) - this repo
...
- [A markdown guide](https://rajatrajdeep.in/blog/github-markdown-guide)
- [Learn more about images in Next.js](https://rajatrajdeep.in/blog/guide-to-using-images-in-nextjs)
- [A tour of math typesetting](https://rajatrajdeep.in/blog/deriving-ols-estimator)
- [Simple MDX image grid](https://rajatrajdeep.in/blog/pictures-of-canada)
- [Example of long prose](https://rajatrajdeep.in/blog/the-time-machine)
- [Example of Nested Route Post](https://rajatrajdeep.in/blog/nested-route/introducing-multi-part-posts-with-nested-routing)
...
authors: ['default', 'sparrowhawk']
layout: PostLayout
canonicalUrl: https://rajatrajdeep.in/blog/introducing-tailwind-nextjs-starter-blog
---
```
